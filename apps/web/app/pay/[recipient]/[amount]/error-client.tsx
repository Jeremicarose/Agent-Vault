...
const ERROR_MESSAGES: Record<ErrorType, { title: string; description: string }> = {
  ...
  domain_not_found: {
    ...
    description: 'The domain could not be resolved. It may not exist or may not have a wallet address configured.',
  },
  invalid_address: {
    title: 'Invalid Address',
    description: 'The recipient address is not a valid address. It should start with 0x followed by 40 hexadecimal characters.',
  },
}
        ...
        <div className="p-4 rounded-lg bg-muted/50 space-y-2">
          ...
          {errorType === 'domain_not_found' && (
            <p className="text-xs text-muted-foreground mt-2">
              Make sure the domain is registered and has a wallet address configured.
            </p>
          )}
        </div>
