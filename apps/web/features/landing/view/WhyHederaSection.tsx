            ...
            <Card className="group hover:border-primary/50 hover:shadow-lg transition-all duration-300 bg-card/50">
              <CardHeader className="space-y-4">
                ...
                <CardDescription className="text-base leading-relaxed">
                  AgentVault is deployed on Hedera EVM and integrates directly with Hedera DeFi protocols, enabling agent-driven swaps, data access and on-chain automation.
                </CardDescription>
              </CardHeader>
            </Card>
